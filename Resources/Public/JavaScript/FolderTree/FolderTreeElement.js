...
/**
 * Module: TYPO3/CMS/DigitalAssetManagement/FolderTree/FolderTreeElement
 */
define(['jquery', 'TYPO3/CMS/DigitalAssetManagement/FolderTree/FolderTree', 'TYPO3/CMS/Backend/Viewport', 'TYPO3/CMS/Backend/Icons'], function ($, FolderTree, Viewport, Icons) {
    'use strict';
     ...
     */
    FolderTreeElement.initialize = function (selector) {
        $(function () {
            ...
            $element.append(FolderTreeElement.template);
